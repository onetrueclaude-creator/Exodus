...
class TestStorageMetadata:
    def test_create_metadata(self):
        from agentic.galaxy.content import StorageMetadata, ContentType
...
class TestStorageTx:
    def test_create_storage_tx(self):
        from agentic.galaxy.content import StorageTx, ContentType
        from agentic.galaxy.coordinate import GridCoordinate
        tx = StorageTx(
            owner=b"alice",
    ...
    def test_validate_success(self):
        from agentic.galaxy.content import StorageTx, ContentType, validate_storage
        from agentic.galaxy.coordinate import GridCoordinate
