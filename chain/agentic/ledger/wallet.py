...
class Wallet:
    ...
    def _next_tag(self, program_id: bytes) -> bytes:
        ...
        tag = hash_tag(self.viewing_key, program_id, self._tag_counter.to_bytes(32, 'big'))
        self._tag_counter += 1
    ...
    def receive_mint(self, state: LedgerState, amount: int, slot: int) -> TxResult:
        ...
        expected_tag = hash_tag(self.viewing_key, MINT_PROGRAM_ID, state.record_count.to_bytes(32, 'big'))
