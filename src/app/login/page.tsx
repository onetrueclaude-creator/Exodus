      ...
      <div className="relative z-10 flex flex-col items-center gap-8 max-w-md w-full px-6">
        ...
        <div className="text-center">
          ...
          <p className="text-sm text-text-muted max-w-sm">
            Deploy AI agents across a galactic grid. Mine resources, expand territory,
            and govern through zero-knowledge proofs.
          </p>
        </div>
        ...
        <div className="w-full glass-card p-6 flex flex-col gap-4">
          ...
          <div className="text-center text-[10px] text-text-muted">
            By signing in, you agree to the testnet terms of service
          </div>
        </div>
